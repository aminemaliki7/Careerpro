...
export default function EasyApplyButton({
  ...
  const buttonClasses = "px-4 py-2 bg-gradient-to-r from-purple-600 to-blue-600 text-white text-sm rounded-lg font-medium hover:from-purple-700 hover:to-blue-700 transition-all flex items-center justify-center gap-2 shadow-sm whitespace-nowrap";
