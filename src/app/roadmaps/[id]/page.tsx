...
<section className="bg-gradient-to-br from-blue-50 to-indigo-100 py-16">
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    {/* Quick Stats - centered and evenly spaced */}
<div className="flex justify-center mt-6">
  <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-center bg-white rounded-lg p-6 shadow-sm max-w-3xl w-full">
    {/* Total Duration */}
    <div>
