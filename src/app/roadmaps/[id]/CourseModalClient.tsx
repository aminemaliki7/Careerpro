        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-8">
              ...
              {courses.length > 0 && (
                <div>
                  <h4 className="text-xl font-bold text-gray-800 mb-4">Recommended Courses 🎓</h4>
                          ...
                          <div className="flex-1">
                            ...
                            <div className="flex items-center justify-between">
                              ...
                              <div className="flex items-center gap-3">
                                ...
                                <button
                                  onClick={() => handleResourceClick(course.affiliateUrl)}
              ...
              {projectsAndPractices.length > 0 && (
                <div>
                  <h4 className="text-xl font-bold text-gray-800 mb-4">Projects & Practices 🛠️</h4>
                  <div className="space-y-4">
                    {projectsAndPractices.map(resource => (
                      <div key={resource.id} className="border border-gray-200 rounded-lg p-4">
                        <div className="flex items-center gap-4">
                          <div className="flex-shrink-0 w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center">
                            {resource.type === 'Project' ? <Code className="w-5 h-5 text-gray-600" /> : <Book className="w-5 h-5 text-gray-600" />}
                          </div>
                          <div>
              ...
              {certifications.length > 0 && (
                <div>
                  <h4 className="text-xl font-bold text-gray-800 mb-4">Certifications 🏆</h4>
                  <div className="space-y-4">
                    {certifications.map(resource => (
                      <div key={resource.id} className="border border-gray-200 rounded-lg p-4">
                        <div className="flex items-center gap-4">
                          <div className="flex-shrink-0 w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center">
                          ...
                          <div className="flex-1">
                            <h5 className="font-bold text-gray-900">{resource.title}</h5>
                            <p className="text-sm text-gray-600">{resource.description}</p>
                            <span className="text-xs text-gray-500 mt-1 block">Provider: {resource.provider}</span>
                          </div>
                          {resource.url && (
                            <button
