  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/30 to-gray-50 relative overflow-hidden">
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        {/* Form Container */}
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-gray-200 shadow-xl p-6 sm:p-8 lg:p-10 mb-8">
          <StartupSubmissionForm />
        </div>

        {/* Bottom CTA */}
        <div className="bg-gradient-to-r from-[#0A66C2]/5 via-blue-50 to-[#0A66C2]/5 rounded-2xl p-6 sm:p-8 border border-[#0A66C2]/20 text-center">
