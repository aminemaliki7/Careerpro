  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/30 to-gray-50">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="mb-8 sm:mb-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
              ...
              {/* Quick Stats */}
              {(startup.foundedYear || startup.teamSize || startup.fundingStage) && (
                <div className="flex flex-wrap gap-4">
                  {startup.foundedYear && (
                    <div className="bg-white/60 backdrop-blur-sm border border-gray-200 rounded-lg px-4 py-2">
                      ...
                      <p className="font-semibold text-gray-900">{startup.foundedYear}</p>
                    </div>
                  )}
                  {startup.teamSize && (
                    <div className="bg-white/60 backdrop-blur-sm border border-gray-200 rounded-lg px-4 py-2">
                  ...
                  {startup.fundingStage && (
                    <div className="bg-white/60 backdrop-blur-sm border border-gray-200 rounded-lg px-4 py-2">
                      ...
                      <p className="font-semibold text-gray-900">{startup.fundingStage}</p>
                    </div>
                  )}
                </div>
              )}
        ...
        {/* Main Content */}
        <div className="bg-white/60 backdrop-blur-sm rounded-2xl border border-gray-200 shadow-xl overflow-hidden">
        ...
        <div className="mt-12 bg-gradient-to-r from-[#0A66C2]/5 via-blue-50 to-[#0A66C2]/5 rounded-2xl p-8 sm:p-10 border border-[#0A66C2]/20 text-center">
          <div className="max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              {startup.careers_url || startup.website ? (
                <>
                  {startup.careers_url && (
                    <a
