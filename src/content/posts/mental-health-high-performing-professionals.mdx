...
- **Environment matters**: Cool (65-68Â°F), dark (blackout curtains), quiet (white noise if needed).
...
âœ… High performance and mental health aren't opposites-neglecting one eventually destroys the other

âœ… You have 4-6 hours of peak cognitive performance daily; protect these fiercely and rest intentionally

âœ… Boundaries aren't selfish-they're strategic focus on what matters most

âœ… Some anxiety drives performance; chronic anxiety destroys it-learn to manage your sweet spot

âœ… Social connection is a performance multiplier, not a distraction-maintain relationship minimums

âœ… Rest is a competitive advantage; elite performers protect recovery as aggressively as work

âœ… Burnout has early warning signs-catch it at Stage 2, never let it reach Stage 3

âœ… Therapy is maintenance, not crisis management-the best time to start is before you need it

âœ… Your worth isn't your output-you're a whole person who happens to be good at work

âœ… Sustainable excellence over 40 years beats peak performance for 5 followed by burnout
