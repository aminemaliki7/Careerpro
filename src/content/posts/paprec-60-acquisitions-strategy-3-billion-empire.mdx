---
title: "From â‚¬4M to â‚¬3B: How 60 Strategic Acquisitions Built Europe's Recycling Giant"
description: "Jean-Luc Petithuguenin turned a small paper recycler into a â‚¬3 billion empire through methodical acquisitions. Discover the buy-and-build strategy that revolutionized an industry."
...
## The â‚¬4 Million Company That Became a â‚¬3 Billion Empire

**1994:** Jean-Luc Petithuguenin buys a struggling paper-cardboard recycling company in La Courneuve, France. 45 employees. â‚¬4 million revenue.

**2024:** Same company, now called Paprec, generates â‚¬3 billion in revenue with 16,000 employees across 10 countries.
...
**Why it mattered:** Created Paprec Ã‰nergies, making the company France's 3rd largest energy recovery operator
...
ðŸ“ **350 sites** across 10 countries  
â™»ï¸ **16 million tons** collected annually  
ðŸ’¶ **â‚¬3 billion** revenue (from â‚¬4M in 1994)  
ðŸ‘¥ **16,000** employees (from 45)  
âš¡ **24 energy recovery units**  
ðŸŽ¯ **Target: â‚¬5 billion** by 2030  
...
âœ… **Waste management** (Paprec's success)  
âœ… **HVAC services** (residential and commercial)  
âœ… **Landscaping and facilities management**  
âœ… **Funeral services** (highly fragmented)  
âœ… **Veterinary clinics** (consolidation wave starting)  
âœ… **Auto repair shops** (thousands of independents)  
âœ… **Plumbing and electrical services**  
âœ… **Dental practices** (DSOs proving the model)  
âœ… **Home healthcare services**  
...
âœ“ **Identify fragmented sectors** in your region or industry  
âœ“ **Research acquisition multiples** (what do similar businesses sell for?)  
âœ“ **Connect with business brokers** who specialize in your industry  
âœ“ **Study 3-5 successful buy-and-build companies** in different sectors  

### Next 6 Months

âœ“ **Build proprietary deal flow** through direct owner outreach  
âœ“ **Develop your integration playbook** (how you'll improve acquisitions)  
âœ“ **Secure preliminary financing** (talk to banks, build relationships)  
âœ“ **Make your first acquisition** (start small, prove the model)  

### Next 2-5 Years

âœ“ **Execute 3-5 acquisitions** to validate your platform thesis  
âœ“ **Invest in technology** that creates operational gaps  
âœ“ **Build your team** with M&A and integration expertise  
âœ“ **Prepare for acceleration** with capital partners if needed  
...
The result? A â‚¬3 billion empire from a â‚¬4 million starting point.
